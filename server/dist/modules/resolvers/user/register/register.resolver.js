...
const schema = yup.object().shape({
    username: yup
        .string()
        .min(2, registirationErrorMessages_1.errorMessages.usernameNotLongEnough)
        .max(30, registirationErrorMessages_1.errorMessages.usernameLongEnough),
    email: yup.string().min(3).max(255).email(registirationErrorMessages_1.errorMessages.invalidEmail),
    password: yup
        .string()
        .min(3, registirationErrorMessages_1.errorMessages.passwordNotLongEnough)
            ...
            try {
                ...
                if (err.code === "23505") {
                    return {
                        ok: false,
                        errors: [
                            { field: "username", message: "this username already taken" },
                        ],
                    };
                }
            }
