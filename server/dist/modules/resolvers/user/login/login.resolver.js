...
const schema = yup.object().shape({
    usernameOrEmail: yup.string().min(2, registirationErrorMessages_1.errorMessages.usernameNotLongEnough),
    password: yup.string().min(3, registirationErrorMessages_1.errorMessages.passwordNotLongEnough),
});
